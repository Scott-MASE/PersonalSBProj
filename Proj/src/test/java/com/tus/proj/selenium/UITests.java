...
class UITests {
    ...
    private static final String BASE_URL = "http://localhost:9092"; // Update if necessary
    ...
    void testAdminLogin() {
        ...
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(2));
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("admin-logout-button")));
    ...
    void testAdminEditUser() {
        ...
        WebElement editButton = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//tr[td[text()='newUser']]//button[contains(@class, 'edit-btn')]")));
        editButton.click();
        ...
        WebElement updatedUser = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//tr[td[text()='renamedUser']]")));
    ...
    void testAdminDeleteUser() {
        ...
        WebElement deleteButton = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//tr[td[text()='renamedUser']]//button[contains(@class, 'delete-btn')]")));
        deleteButton.click();
        ...
        WebElement alertMessage = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//div[contains(@class, 'alert-success') and text()='User deleted.']")));
    ...
    void testEditAndSaveNoteContent() {
        ...
        WebElement noteTile = wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("button.note-tile-btn[data-note-id='1']")));
        noteTile.click();
        ...
        WebElement alertMessage = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//div[contains(@class, 'alert-success') and text()='Note updated successfully!']")));
        assertTrue(alertMessage.isDisplayed(), "Success alert 'User deleted.' not displayed");
